...
<style>
    ...
    */
    :root {
        ...
        --m-marginalia-title: "My Novel Title";
    }
</style>
...
volutpat odio vitae sapien convallis hendrerit. Nunc eu tincidunt quam.
Praesent at urna molestie, tincidunt mi vitae, dapibus nulla.
...
An epilogue is formatted as an ending chapter. In this case, this "chapter"
only has one scene because … you get the idea.
