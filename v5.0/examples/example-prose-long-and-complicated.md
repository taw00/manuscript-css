...
<div id="vpage" class="">
<article id="manuscript" class="long no-links-export Xnonnarrative Xsimple classic Xtext-only Xno-simulation">
...
## A Compliant "Classic-style" Manuscript with Books (just one), Parts, Chapters, Scenes, and an [Epigraph](https://en.wikipedia.org/wiki/Epigraph_(literature))
